...
class ZerodhaTicker(KiteTicker):
    ...
    def __init__(
        ...
        super(ZerodhaTicker, self).__init__(
            api_key="",
            access_token="",
            debug=debug,
            root=root,
...
class Zerodha(KiteConnect):
    ...
    def __init__(self, user_id=None, password=None, twofa=None, debug=False):
        self.user_id = user_id
        self.password = password
        self.twofa = twofa

        super().__init__(api_key="", debug=debug)
