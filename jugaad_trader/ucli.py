...
def rm(config):
    ...
    if config == "CREDENTIALS":
        try:
            ...
            click.echo(
                "Could not find any credentials, you can save it again using 'jtrader upstox savecreds'"
            )
        else:
            click.echo(
    ...
    if config == "SESSION":
        try:
            ...
            click.echo(
                "Could not find the session config, you can save it again using 'jtrader upstox startsession'"
            )
        else:
            click.echo(
                "Successfully deleted, you can save it again using 'jtrader upstox startsession'"
            )
